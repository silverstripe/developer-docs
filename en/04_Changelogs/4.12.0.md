...
Substantial work went into normalising our deprecation warnings and identifying code that will be removed in Silverstripe CMS 5. This will make it easier for Silverstripe CMS 4 projects to upgrade to CMS 5 by clearing marking which APIs will be removed in the next major release. Deprecated APIs are still part of the official Silverstripe CMS 4 codebase and can be still be used. Deprecated code is marked with the `@deprecated` PHPDoc annotation.

Further deprecation will be added to Silverstripe CMS 4.13 which will be released just prior to Silverstripe CMS 5. Formal guidance on enabling deprecation warnings will be provided closer to the Silverstripe CMS 5 release.
