...
| silverstripe/login-forms | 4.8.0 |
...
| silverstripe/ckan-registry | 1.6.0 |
| silverstripe/comment-notifications | 2.3.0 |
| silverstripe/comments | 3.9.0 |
| silverstripe/content-widget | 2.4.0 |
| silverstripe/contentreview | 4.6.0 |
| silverstripe/crontask | 2.5.0 |
| silverstripe/documentconverter | 2.4.0 |
| silverstripe/elemental-bannerblock | 2.6.0 |
| silverstripe/elemental-fileblock | 2.4.0 |
| silverstripe/environmentcheck | 2.6.0 |
...
| silverstripe/hybridsessions | 2.6.0 |
| silverstripe/iframe | 2.3.0 |
| silverstripe/ldap | 1.5.0 |
| silverstripe/mfa | 4.7.0 |
| silverstripe/realme | 4.3.0 |
| silverstripe/registry | 2.5.0 |
| silverstripe/restfulserver | 2.5.0 |
| silverstripe/security-extensions | 4.4.0 |
| silverstripe/securityreport | 2.5.0 |
| silverstripe/segment-field | 2.7.0 |
| silverstripe/sharedraftcontent | 2.8.0 |
...
| silverstripe/totp-authenticator | 4.5.0 |
| silverstripe/userforms | 5.14.0 |
| silverstripe/versionfeed | 2.3.0 |
| silverstripe/webauthn-authenticator | 4.6.0 |
| silverstripe/widgets | 2.3.0 |
| symbiote/silverstripe-advancedworkflow | 5.8.0 |
| symbiote/silverstripe-multivaluefield | 5.3.0 |
| symbiote/silverstripe-queuedjobs | 4.11.0 |
...
Read the [*SameSite cookies* article on MDN Web Doc](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Set-Cookie/SameSite) for more information about the `samesite` attribute.
...
- silverstripe/recipe-reporting-tools (1.11.0 -&gt; 1.12.0)
...
- silverstripe/developer-docs (4.11.0 -&gt; 4.12.0)
  - 2022-12-15 [4300c4a4](https://github.com/silverstripe/developer-docs/commit/4300c4a4ea7a83177657c34736881512a6a6a563) Apply suggestions from code review (Maxime Rainville)
