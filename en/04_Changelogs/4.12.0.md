...
In the [Silverstripe CMS 4.4 release](4.4.0/#optional-migration-tasks-overview), many aspects of the `silverstripe/assets` module were refactored to support permanent link.
...
With Silverstripe CMS 5 on the horizon, it is an opportune time to formalise some of those abstractions and to deprecate those migration task.
...
These new abstraction, make several APIs redundant. The following method are deprecated in the Silverstripe CMS 4.12 release and will be removed in Silverstripe CMS 5:
...
Silverstripe CMS 4 includes multiple task to migrate files to newer states. These task will no longer be needed in Silverstripe CMS 5. The following task and helpers have been deprecated in Silverstripe CMS 4 and will be removed in Silverstripe CMS 5:
