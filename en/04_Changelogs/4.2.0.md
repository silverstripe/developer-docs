...
The following methods have been added to [`Versioned`](api:SilverStripe\Versioned\Versioned) class:
...
A new class [`ReadingMode`](api:SilverStripe\Versioned\ReadingMode) has also been added to assist with
