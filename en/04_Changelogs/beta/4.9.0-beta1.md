...
| Module | Version |
| ------ | ------- |
| silverstripe/admin | 1.9.0-beta1 |
| silverstripe/asset-admin | 1.9.0-beta1 |
| silverstripe/assets | 1.9.0-beta1 |
| silverstripe/campaign-admin | 1.9.0-beta1 |
| silverstripe/cms | 1.9.0-beta1 |
| silverstripe/config | 1.2.0-beta1 |
| silverstripe/errorpage | 1.9.0-beta1 |
| silverstripe/framework | 4.9.0-beta1 |
| silverstripe/graphql | 3.6.0-beta1 |
| silverstripe/login-forms | 4.5.0-beta1 |
| silverstripe/mimevalidator | 2.2.0-beta1 |
| silverstripe/reports | 4.9.0-beta1 |
| silverstripe/session-manager | 1.1.0-beta1 |
| silverstripe/siteconfig | 4.9.0-beta1 |
| silverstripe/versioned | 1.9.0-beta1 |
| silverstripe/versioned-admin | 1.9.0-beta1 |
</details>
...
| silverstripe/blog | 3.8.0-beta1 |
| silverstripe/ckan-registry | 1.3.0-beta1 |
| silverstripe/comment-notifications | 2.1.0 |
| silverstripe/comments | 3.6.0-beta1 |
| silverstripe/content-widget | 2.2.0 |
| silverstripe/contentreview | 4.3.0-beta1 |
| silverstripe/controllerpolicy | 2.2.0 |
| silverstripe/crontask | 2.3.0-beta1 |
| silverstripe/documentconverter | 2.1.1 |
| silverstripe/elemental-bannerblock | 2.3.0-beta1 |
| silverstripe/elemental-fileblock | 2.2.0-beta1 |
| silverstripe/environmentcheck | 2.3.0 |
| silverstripe/externallinks | 2.1.1 |
| silverstripe/fulltextsearch | 3.8.0 |
| silverstripe/gridfieldqueuedexport | 2.5.0-beta1 |
| silverstripe/html5 | 2.1.0 |
| silverstripe/hybridsessions | 2.3.0-beta1 |
| silverstripe/iframe | 2.1.0 |
| silverstripe/ldap | 1.2.1 |
| silverstripe/mfa | 4.4.0-beta1 |
...
| silverstripe/sharedraftcontent | 2.5.0-beta1 |
...
| silverstripe/tagfield | 2.7.0-beta1 |
| silverstripe/taxonomy | 2.2.0 |
| silverstripe/textextraction | 3.2.0 |
| silverstripe/totp-authenticator | 4.2.0-beta1 |
| silverstripe/userforms | 5.10.0-beta1 |
| silverstripe/versionfeed | 2.1.0-beta1 |
| silverstripe/webauthn-authenticator | 4.3.0-beta1 |
| silverstripe/widgets | 2.1.1 |
| symbiote/silverstripe-advancedworkflow | 5.5.0-beta1 |
...
- silverstripe/crontask (2.2.0 -&gt; 2.3.0-beta1)
...
- silverstripe/errorpage (1.8.0 -&gt; 1.9.0-beta1)
...
- silverstripe/gridfieldqueuedexport (2.4.0 -&gt; 2.5.0-beta1)
...
- silverstripe/hybridsessions (2.2.1 -&gt; 2.3.0-beta1)
