...
| bringyourownideas/silverstripe-maintenance | 2.7.0-beta1 |
| cwp/agency-extensions | 2.7.0 |
| cwp/cwp | 2.11.0-beta1 |
| cwp/cwp-core | 2.12.0-beta1 |
| cwp/cwp-pdfexport | 1.5.0-beta1 |
| cwp/cwp-search | 1.8.0-beta1 |
| cwp/starter-theme | 3.3.0-beta1 |
| cwp/watea-theme | 3.2.0-beta1 |
| dnadesign/silverstripe-elemental | 4.11.0-beta1 |
| dnadesign/silverstripe-elemental-userforms | 3.3.0-beta1 |
| silverstripe/admin | 1.13.0-beta1 |
| silverstripe/akismet | 4.5.0-beta1 |
| silverstripe/asset-admin | 1.13.0-beta1 |
| silverstripe/assets | 1.13.0-beta1 |
| silverstripe/auditor | 2.6.0-beta1 |
| silverstripe/blog | 3.12.0-beta1 |
| silverstripe/campaign-admin | 1.13.0-beta1 |
| silverstripe/ckan-registry | 1.7.0-beta1 |
| silverstripe/cms | 4.13.0-beta1 |
| silverstripe/comment-notifications | 2.4.0-beta1 |
| silverstripe/comments | 3.10.0-beta1 |
| silverstripe/config | 1.6.0-beta1 |
| silverstripe/content-widget | 2.4.0 |
| silverstripe/contentreview | 4.7.0-beta1 |
| silverstripe/crontask | 2.6.0-beta1 |
| silverstripe/developer-docs | 4.12.0 |
| silverstripe/documentconverter | 2.5.0-beta1 |
| silverstripe/elemental-bannerblock | 2.7.0-beta1 |
| silverstripe/elemental-fileblock | 2.5.0-beta1 |
| silverstripe/environmentcheck | 2.7.0-beta1 |
| silverstripe/errorpage | 1.13.0-beta1 |
| silverstripe/externallinks | 2.4.0-beta1 |
| silverstripe/framework | 4.13.0-beta1 |
| silverstripe/fulltextsearch | 3.12.0-beta1 |
| silverstripe/graphql | 4.2.2 |
| silverstripe/gridfieldqueuedexport | 2.8.0-beta1 |
| silverstripe/hybridsessions | 2.7.0-beta1 |
| silverstripe/iframe | 2.4.0-beta1 |
| silverstripe/installer | 4.13.0-beta1 |
| silverstripe/ldap | 1.6.0-beta1 |
| silverstripe/login-forms | 4.9.0-beta1 |
| silverstripe/mfa | 4.8.0-beta1 |
| silverstripe/mimevalidator | 2.5.0-beta1 |
| silverstripe/realme | 4.4.0-beta1 |
| silverstripe/recipe-authoring-tools | 1.13.0-beta1 |
| silverstripe/recipe-blog | 1.13.0-beta1 |
| silverstripe/recipe-ccl | 2.13.0-beta1 |
| silverstripe/recipe-cms | 4.13.0-beta1 |
| silverstripe/recipe-collaboration | 1.13.0-beta1 |
| silverstripe/recipe-content-blocks | 2.13.0-beta1 |
| silverstripe/recipe-core | 4.13.0-beta1 |
| silverstripe/recipe-form-building | 1.13.0-beta1 |
| silverstripe/recipe-kitchen-sink | 4.13.0-beta1 |
| silverstripe/recipe-reporting-tools | 1.13.0-beta1 |
| silverstripe/recipe-services | 1.13.0-beta1 |
| silverstripe/recipe-solr-search | 2.13.0-beta1 |
| silverstripe/registry | 2.6.0-beta1 |
| silverstripe/reports | 4.13.0-beta1 |
| silverstripe/restfulserver | 2.6.0-beta1 |
| silverstripe/security-extensions | 4.5.0-beta1 |
| silverstripe/securityreport | 2.6.0-beta1 |
| silverstripe/segment-field | 2.8.0-beta1 |
| silverstripe/session-manager | 1.5.0-beta1 |
| silverstripe/sharedraftcontent | 2.9.0-beta1 |
| silverstripe/siteconfig | 4.13.0-beta1 |
| silverstripe/sitewidecontent-report | 3.4.0-beta1 |
| silverstripe/spamprotection | 3.4.0-beta1 |
| silverstripe/spellcheck | 2.5.0-beta1 |
| silverstripe/subsites | 2.4.0 |
| silverstripe/tagfield | 2.11.0-beta1 |
| silverstripe/taxonomy | 2.5.0-beta1 |
| silverstripe/textextraction | 3.5.0-beta1 |
| silverstripe/totp-authenticator | 4.6.0-beta1 |
| silverstripe/userforms | 5.15.0-beta1 |
| silverstripe/versioned | 1.13.0-beta1 |
| silverstripe/versioned-admin | 1.13.0-beta1 |
| silverstripe/versionfeed | 2.4.0-beta1 |
| silverstripe/webauthn-authenticator | 4.7.0-beta1 |
| silverstripe/widgets | 2.4.0-beta1 |
| symbiote/silverstripe-advancedworkflow | 5.9.0-beta1 |
| symbiote/silverstripe-multivaluefield | 5.4.0-beta1 |
 ...
 * silverstripe/sitewidecontent-report (3.3.0 -&gt; 3.4.0-beta1)
 ...
 * silverstripe/recipe-blog (1.12.0 -&gt; 1.13.0-beta1)
 ...
 * silverstripe/textextraction (3.4.0 -&gt; 3.5.0-beta1)
