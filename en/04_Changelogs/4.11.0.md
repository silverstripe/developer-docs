...
| silverstripe/hybridsessions | 2.5.1 |
...
| silverstripe/sharedraftcontent | 2.7.0 |
...
- silverstripe/admin (1.10.0 -&gt; 1.11.0)
  - 2022-04-20 [d3ae28bb](https://github.com/silverstripe/silverstripe-admin/commit/d3ae28bb8d966448d6bafb23dabc0c7035798f8f) PHP 8.1 compatibility (Steve Boyd)
  ...
  - 2022-01-31 [759b06bc](https://github.com/silverstripe/silverstripe-admin/commit/759b06bcd24004a7bc7e2ab5f4995eb88122ecee) Allow unversioned preview state. (#1258) (GuySartorelli)
...
- silverstripe/asset-admin (1.10.0 -&gt; 1.11.0)
...
- silverstripe/campaign-admin (1.10.0 -&gt; 1.11.0)
...
- silverstripe/versioned-admin (1.10.0 -&gt; 1.11.0)
...
- silverstripe/session-manager (1.2.0 -&gt; 1.3.0)
...
- silverstripe/documentconverter (2.2.0 -&gt; 2.3.0)
...
- silverstripe/widgets (2.2.0 -&gt; 2.3.0)
...
- silverstripe/comment-notifications (2.2.0 -&gt; 2.3.0)
...
- silverstripe/contentreview (4.4.0 -&gt; 4.5.0)
...
- silverstripe/sharedraftcontent (2.6.0 -&gt; 2.7.0)
...
- silverstripe/segment-field (2.5.0 -&gt; 2.6.0)
...
- silverstripe/externallinks (2.2.0 -&gt; 2.3.0)
...
- silverstripe/sitewidecontent-report (3.2.0 -&gt; 3.3.0)
...
- silverstripe/restfulserver (2.4.0 -&gt; 2.5.0)
...
- dnadesign/silverstripe-elemental (4.8.0 -&gt; 4.9.0)
...
- silverstripe/elemental-bannerblock (2.4.0 -&gt; 2.5.0)
...
- silverstripe/totp-authenticator (4.3.0 -&gt; 4.4.0)
...
- silverstripe/gridfieldqueuedexport (2.6.1 -&gt; 2.7.0)
...
- silverstripe/webauthn-authenticator (4.4.1 -&gt; 4.5.0)
...
- tractorcow/silverstripe-fluent (4.6.0 -&gt; 4.7.0)
...
- silverstripe/admin (1.10.0 -&gt; 1.11.0)
  - 2022-04-11 [22e76651](https://github.com/silverstripe/silverstripe-admin/commit/22e766519d3a6e92f70f553c4fea505d8950c275) Start react event delegation before page router. (#1299) (Guy Sartorelli)
  - 2022-02-22 [272609d7](https://github.com/silverstripe/silverstripe-admin/commit/272609d78fd55c56238c89ccf481f86d5212dcba) Add missing dependency to build pattern library (Maxime Rainville)
...
- silverstripe/recipe-kitchen-sink (4.10.0 -&gt; 4.11.0)
...
- silverstripe/admin (1.10.0 -&gt; 1.11.0)
  ...
  - 2022-03-11 [7dbd07c0](https://github.com/silverstripe/silverstripe-admin/commit/7dbd07c0cafe1143f028f360cfcd3c14494a60e1) Update eslint-config (Steve Boyd)
...
- silverstripe/recipe-authoring-tools (1.10.0 -&gt; 1.11.0)
...
- silverstripe/recipe-collaboration (1.10.0 -&gt; 1.11.0)
...
- silverstripe/recipe-form-building (1.10.0 -&gt; 1.11.0)
...
- silverstripe/recipe-reporting-tools (1.10.0 -&gt; 1.11.0)
...
- silverstripe/recipe-services (1.10.0 -&gt; 1.11.0)
...
- silverstripe/recipe-content-blocks (2.10.0 -&gt; 2.11.0)
...
- silverstripe/elemental-fileblock (2.3.0 -&gt; 2.4.0)
...
- silverstripe/recipe-solr-search (2.10.0 -&gt; 2.11.0)
...
- silverstripe/security-extensions (4.2.1 -&gt; 4.3.0)
...
- silverstripe/admin (1.10.0 -&gt; 1.11.0)
  - 2022-05-04 [3488ab77](https://github.com/silverstripe/silverstripe-admin/commit/3488ab7789a0c50fee9e8684b83eebe554468003) Update translations (Steve Boyd)
...
- silverstripe/graphql (3.7.1 -&gt; 4.0.0)
  - 2022-06-22 [d0b0304](https://github.com/silverstripe/silverstripe-graphql/commit/d0b03042476edf868179c54f67a903dad44e3345) Update src/QueryHandler/QueryHandler.php (Jordy Rosenbrand)
