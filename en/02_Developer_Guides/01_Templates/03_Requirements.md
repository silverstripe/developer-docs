...
Exposed assets are made available in your web root in a dedicated "_resources" directory.
...
Developers can explicitly expose static assets by calling `composer vendor-expose`. This is necessary after updating your `expose` configuration in your `composer.json` file.
