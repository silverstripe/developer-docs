...
Querying nested relationships inside a loop using the ORM is prone to the N + 1 query problem. This can be alleviated using [eager loading](../08_Performance/eager_loading).
