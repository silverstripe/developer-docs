...
Modules that are supported for one major release line may not be supported for follow up release lines. Supported modules can be rename or their namespaces can be changed when a new Silverstripe CMS major release is published.
