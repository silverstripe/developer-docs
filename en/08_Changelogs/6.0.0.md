...
`cwp/cwp-core` also changed the *default* hasher, but for CMS 6 the hashing algorithm is `blowfish`. If you wish to change the default hashing algorithm to `sha12`, you can do so with this YAML snippet:
