...
A full list of module versions included in CMS Recipe 6.2.0-rc1 is provided below. We recommend referencing recipes in your dependencies, rather than individual modules, to simplify version tracking. See [Recipes](/getting_started/).
...
| dnadesign/silverstripe-elemental-userforms | 5.1.0-rc1 |
...
| silverstripe/gridfieldqueuedexport | 4.1.0-rc1 |
| silverstripe/htmleditor-tinymce | 1.1.0-rc1 |
| silverstripe/installer | 6.2.0-rc1 |
| silverstripe/linkfield | 5.2.0-rc1 |
| silverstripe/login-forms | 6.2.0-rc1 |
| silverstripe/lumberjack | 4.1.0-rc1 |
...
| silverstripe/segment-field | 4.1.0-rc1 |
...
| silverstripe/totp-authenticator | 6.1.0-rc1 |
| silverstripe/userforms | 7.1.0-rc1 |
...
- silverstripe/assets (3.1.0 -&gt; 3.2.0-rc1)
...
- silverstripe/config (3.0.0 -&gt; 3.1.0-rc1)
...
- silverstripe/framework (6.1.0 -&gt; 6.2.0-rc1)
...
- silverstripe/admin (3.1.0 -&gt; 3.2.0-rc1)
...
- silverstripe/asset-admin (3.1.0 -&gt; 3.2.0-rc1)
...
- silverstripe/versioned-admin (3.1.0 -&gt; 3.2.0-rc1)
...
- silverstripe/cms (6.1.0 -&gt; 6.2.0-rc1)
...
- silverstripe/reports (6.1.0 -&gt; 6.2.0-rc1)
...
- silverstripe/versioned (3.1.0 -&gt; 3.2.0-rc1)
...
- silverstripe/login-forms (6.1.0 -&gt; 6.2.0-rc1)
...
- silverstripe/htmleditor-tinymce (1.0.2 -&gt; 1.1.0-rc1)
...
- silverstripe/totp-authenticator (6.0.2 -&gt; 6.1.0-rc1)
...
- silverstripe/mfa (6.1.0 -&gt; 6.2.0-rc1)
...
- silverstripe/gridfieldqueuedexport (4.0.2 -&gt; 4.1.0-rc1)
...
- silverstripe/segment-field (4.0.2 -&gt; 4.1.0-rc1)
...
- silverstripe/sharedraftcontent (4.1.0 -&gt; 4.2.0-rc1)
...
- silverstripe/lumberjack (4.0.3 -&gt; 4.1.0-rc1)
...
- silverstripe/tagfield (4.1.0 -&gt; 4.2.0-rc1)
...
- silverstripe/taxonomy (4.1.0 -&gt; 4.2.0-rc1)
...
- silverstripe/userforms (7.0.2 -&gt; 7.1.0-rc1)
...
- dnadesign/silverstripe-elemental (6.1.0 -&gt; 6.2.0-rc1)
  ...
  - 2025-12-16 [8a966fd](https://github.com/silverstripe/silverstripe-elemental/commit/8a966fd43689d25763ea58ecb7c54c92a1b13bfc) Refactor react components from class to functional (#1393) (Steve Boyd)
...
- symbiote/silverstripe-advancedworkflow (7.1.0 -&gt; 7.2.0-rc1)
...
- symbiote/silverstripe-gridfieldextensions (5.1.0 -&gt; 5.2.0-rc1)
...
- symbiote/silverstripe-queuedjobs (6.1.0 -&gt; 6.2.0-rc1)
...
- colymba/gridfield-bulk-editing-tools (5.1.0 -&gt; 5.2.0-rc1)
...
- tractorcow/silverstripe-fluent (8.1.0 -&gt; 8.2.0-rc1)
...
- silverstripe/linkfield (5.1.0 -&gt; 5.2.0-rc1)
...
- silverstripe/campaign-admin (3.1.0 -&gt; 3.2.0-rc1)
...
- silverstripe/recipe-kitchen-sink (6.1.0 -&gt; 6.2.0-rc1)
...
- silverstripe/installer (6.1.0 -&gt; 6.2.0-rc1)
...
- silverstripe/recipe-cms (6.1.0 -&gt; 6.2.0-rc1)
...
- dnadesign/silverstripe-elemental-userforms (5.0.0 -&gt; 5.1.0-rc1)
...
- silverstripe/developer-docs (6.1.0 -&gt; 6.2.0-rc1)
