...
- [Other changes](#other-changes)
  ...
  - [`$CurrentPageURL` template support removed](#current-page-url)
- [Full list of removed and changed API (by module, alphabetically)](#api-removed-and-changed)
- [Full commits list](#full-commits-list)

A full list of module versions included in CMS Recipe 6.0.0-rc1 is provided below. We recommend referencing recipes in your dependencies, rather than individual modules, to simplify version tracking. See [Recipes](/getting_started/).
...
| Module | Version |
| ------ | ------- |
| colymba/gridfield-bulk-editing-tools | 5.0.0-rc1 |
| dnadesign/silverstripe-elemental | 6.0.0-rc1 |
| dnadesign/silverstripe-elemental-userforms | 5.0.0-rc1 |
| silverstripe/admin | 3.0.0-rc1 |
| silverstripe/asset-admin | 3.0.0-rc1 |
| silverstripe/assets | 3.0.0-rc1 |
| silverstripe/blog | 5.0.0-rc1 |
| silverstripe/campaign-admin | 3.0.0-rc1 |
| silverstripe/cms | 6.0.0-rc1 |
| silverstripe/config | 3.0.0-rc1 |
| silverstripe/crontask | 4.0.0-rc1 |
| silverstripe/dynamodb | 6.0.0-rc1 |
| silverstripe/environmentcheck | 4.0.0-rc1 |
| silverstripe/errorpage | 3.0.0-rc1 |
| silverstripe/framework | 6.0.0-rc1 |
| silverstripe/graphql | 6.0.0-rc1 |
| silverstripe/gridfieldqueuedexport | 4.0.0-rc1 |
| silverstripe/htmleditor-tinymce | 1.0.0-rc1 |
| silverstripe/hybridsessions | 4.0.0-rc1 |
| silverstripe/installer | 6.0.0-rc1 |
| silverstripe/linkfield | 5.0.0-rc1 |
| silverstripe/login-forms | 6.0.0-rc1 |
| silverstripe/lumberjack | 4.0.0-rc1 |
| silverstripe/mfa | 6.0.0-rc1 |
| silverstripe/mimevalidator | 4.0.0-rc1 |
| silverstripe/realme | 6.0.0-rc1 |
| silverstripe/recipe-cms | 6.0.0-rc1 |
| silverstripe/recipe-core | 6.0.0-rc1 |
| silverstripe/recipe-kitchen-sink | 6.0.0-rc1 |
| silverstripe/recipe-plugin | 2.1.0 |
| silverstripe/reports | 6.0.0-rc1 |
| silverstripe/segment-field | 4.0.0-rc1 |
| silverstripe/session-manager | 3.0.0-rc1 |
| silverstripe/sharedraftcontent | 4.0.0-rc1 |
| silverstripe/siteconfig | 6.0.0-rc1 |
| silverstripe/spamprotection | 5.0.0-rc1 |
| silverstripe/startup-theme | 1.0.0-rc1 |
| silverstripe/staticpublishqueue | 7.0.0-rc1 |
| silverstripe/subsites | 4.0.0-rc1 |
| silverstripe/tagfield | 4.0.0-rc1 |
| silverstripe/taxonomy | 4.0.0-rc1 |
| silverstripe/template-engine | 1.0.0-rc1 |
| silverstripe/textextraction | 5.0.0-rc1 |
| silverstripe/totp-authenticator | 6.0.0-rc1 |
| silverstripe/userforms | 7.0.0-rc1 |
| silverstripe/vendor-plugin | 3.0.0-rc1 |
| silverstripe/versioned | 3.0.0-rc1 |
| silverstripe/versioned-admin | 3.0.0-rc1 |
| silverstripe/webauthn-authenticator | 6.0.0-rc1 |
| symbiote/silverstripe-advancedworkflow | 7.0.0-rc1 |
| symbiote/silverstripe-gridfieldextensions | 5.0.0-rc1 |
| symbiote/silverstripe-queuedjobs | 6.0.0-rc1 |
| tractorcow/silverstripe-fluent | 8.0.0-rc1 |
...
- [`DBBoolean`](api:SilverStripe\ORM\FieldType\DBBoolean) will no longer convert non-boolean like values to a `bool` when calling `setValue()`. For instance `"Amazing"` will no longer be converted to `true`, instead its value will remain as `"Amazing"` and it will throw a validation exception if attempted to be written to the database. There are some boolean-like values, such as `"t"`, that will continue to be converted to their boolean equivalents for backwards compatibility.
...
- [`DBDecimal`](api:SilverStripe\ORM\FieldType\DBDecimal) will no longer parse numeric values contained in a string when calling `setValue()` unless the string is entirely numeric. For example `"This is -123.45"` will no longer be converted to `"-123.45"`, instead its value will remain as `"This is -123.45"` and it will throw a validation exception if attempted to be written to the database. Fully numeric strings like `"-123.45"` will still be cast and not throw validation exceptions.
- [`DBPercentage`](api:SilverStripe\ORM\FieldType\DBPercentage) stores values internally as a float. It will no longer convert values above `1.0` such as `2.3` to `1.0` when calling `setValue()`. Instead, it will keep the value as `2.3`. If the value exceeds the value of [`DBPercentage::getMaxValue()`](api:SilverStripe\ORM\FieldType\DBPercentage::getMaxValue()), which has a default value of `1.0` though can be overriden in a subclass, then it will throw a validation exception if attempted to be written to the database.
...
`cwp/cwp-core` is no longer a commercially supported module, however the password hasher has been moved into `silverstripe/framework` as [`PasswordEncryptorPBKDF2`](api:SilverStripe\Security\PasswordEncryptorPBKDF2).
...
Part of this upgrade includes a change to assertions expecting warnings, errors, and notices. See [asserting errors, warnings and notices](/developer_guides/testing/unit_testing/#asserting-errors-warnings-and-notices) for details.
...
- The execution flow for [`ChangePasswordHandler::changepassword()`](api:SilverStripe\Security\MemberAuthenticator\ChangePasswordHandler::changepassword()) has changed slightly. The session isn't updated until after the redirect now. If you overrode that method expecting the session to be updated prior to the redirect, you probably want to override the new protected [`createChangePasswordResponse()`](api:SilverStripe\Security\MemberAuthenticator\ChangePasswordHandler::createChangePasswordResponse()) method instead.
...
- Changed default value for config [`LeftAndMain.dependencies`](api:SilverStripe\Admin\LeftAndMain->dependencies) - array values have changed
- Changed default value for config [`LeftAndMain.help_links`](api:SilverStripe\Admin\LeftAndMain->help_links) - array values have changed
- Changed default value for config [`LeftAndMain.required_permission_codes`](api:SilverStripe\Admin\LeftAndMain->required_permission_codes) from `null` to `[]`
- Changed default value for config [`SudoModeController.help_link`](api:SilverStripe\Admin\SudoModeController->help_link) from `'https://userhelp.silverstripe.org/en/5/managing_your_website/logging_in/#sudo-mode'` to `'https://userhelp.silverstripe.org/en/6/managing_your_website/logging_in/#sudo-mode'`
...
- Removed deprecated property `SilverStripe\CMS\Model\SiteTree->_cache_statusFlags` - moved to [`ModelData`](api:SilverStripe\Model\ModelData) and made private
- Removed deprecated property `SilverStripe\CMS\Model\SiteTree->creatableChildrenCache` - moved to [`CMSMain`](api:SilverStripe\CMS\Controllers\CMSMain) and made private
...
- Method [`SiteTree::getPermissionChecker()`](api:SilverStripe\CMS\Model\SiteTree::getPermissionChecker()) is no longer static
- Changed default value for config [`SiteTree.allowed_children`](api:SilverStripe\CMS\Model\SiteTree->allowed_children) - array values have changed
- Changed default value for config [`SiteTree.default_child`](api:SilverStripe\CMS\Model\SiteTree->default_child) from `'Page'` to `Page`
...
- Removed deprecated parameter `$request` in [`Session::requestContainsSessionId()`](api:SilverStripe\Control\Session::requestContainsSessionId())
...
- Changed return type for method [`ChangePasswordHandler::setSessionToken()`](api:SilverStripe\Security\MemberAuthenticator\ChangePasswordHandler::setSessionToken()) from dynamic to `void`
...
- Changed return type for method [`DBMoney::getAmount()`](api:SilverStripe\ORM\FieldType\DBMoney::getAmount()) from dynamic to `mixed`
...
- Changed type of parameter `$expiry` in [`Cookie::set()`](api:SilverStripe\Control\Cookie::set()) from dynamic to `int|float`
...
- Changed type of parameter `$expiry` in [`Cookie_Backend::set()`](api:SilverStripe\Control\Cookie_Backend::set()) from dynamic to `int|float`
...
- Changed type of parameter `$member` in [`ChangePasswordHandler::setSessionToken()`](api:SilverStripe\Security\MemberAuthenticator\ChangePasswordHandler::setSessionToken()) from dynamic to [`Member`](api:SilverStripe\Security\Member)
...
- Changed type of parameter `$token` in [`ChangePasswordHandler::setSessionToken()`](api:SilverStripe\Security\MemberAuthenticator\ChangePasswordHandler::setSessionToken()) from dynamic to `string`
...
- Added new parameter `$alreadyEncrypted` in [`ChangePasswordHandler::setSessionToken()`](api:SilverStripe\Security\MemberAuthenticator\ChangePasswordHandler::setSessionToken())
...
- Method [`BuildTask::getDescription()`](api:SilverStripe\Dev\BuildTask::getDescription()) is now static
- Method [`DBEnum::flushCache()`](api:SilverStripe\ORM\FieldType\DBEnum::flushCache()) is no longer static
...
- Changed default value for config [`DataObject.scaffold_cms_fields_settings`](api:SilverStripe\ORM\DataObject->scaffold_cms_fields_settings) - array values have changed
- Changed default value for config [`BuildTask.is_enabled`](api:SilverStripe\Dev\BuildTask->is_enabled) from `null` to `true`
- Changed default value for config [`MySQLDatabase.charset`](api:SilverStripe\ORM\Connect\MySQLDatabase->charset) from `'utf8'` to `'utf8mb4'`
- Changed default value for config [`MySQLDatabase.collation`](api:SilverStripe\ORM\Connect\MySQLDatabase->collation) from `'utf8_general_ci'` to `'utf8mb4_unicode_ci'`
- Changed default value for config [`MySQLDatabase.connection_charset`](api:SilverStripe\ORM\Connect\MySQLDatabase->connection_charset) from `'utf8'` to `'utf8mb4'`
- Changed default value for config [`MySQLDatabase.connection_collation`](api:SilverStripe\ORM\Connect\MySQLDatabase->connection_collation) from `'utf8_general_ci'` to `'utf8mb4_unicode_ci'`
- Changed default value for config [`Session.cookie_samesite`](api:SilverStripe\Control\Session->cookie_samesite) from [`Cookie::SAMESITE_LAX`](api:SilverStripe\Control\Cookie::SAMESITE_LAX) to [`Cookie::SAMESITE_STRICT`](api:SilverStripe\Control\Cookie::SAMESITE_STRICT)
- Changed default value for config [`Session.cookie_secure`](api:SilverStripe\Control\Session->cookie_secure) from `false` to `true`
- Changed default value for parameter `$arguments` in [`SSViewer::process()`](api:SilverStripe\View\SSViewer::process()) from `null` to `[]`
- Changed default value for parameter `$expiry` in [`CookieJar::outputCookie()`](api:SilverStripe\Control\CookieJar::outputCookie()) from `90` to none
...
- Changed default value for config [`LoginHandler.user_help_link`](api:SilverStripe\MFA\Authenticator\LoginHandler->user_help_link) from `'https://userhelp.silverstripe.org/en/5/optional_features/multi-factor_authentication/'` to `'https://userhelp.silverstripe.org/en/6/optional_features/multi-factor_authentication/'`
- Changed default value for config [`RegisterHandler.user_help_link`](api:SilverStripe\MFA\BackupCode\RegisterHandler->user_help_link) from `'https://userhelp.silverstripe.org/en/5/optional_features/multi-factor_authentication/user_manual/regaining_access/'` to `'https://userhelp.silverstripe.org/en/6/optional_features/multi-factor_authentication/user_manual/regaining_access/'`
- Changed default value for config [`SiteConfigExtension.mfa_help_link`](api:SilverStripe\MFA\Extension\SiteConfigExtension->mfa_help_link) from `'https://userhelp.silverstripe.org/en/5/optional_features/multi-factor_authentication/'` to `'https://userhelp.silverstripe.org/en/6/optional_features/multi-factor_authentication/'`
...
- Changed default value for config [`InitStateMiddleware.admin_url_paths`](api:SilverStripe\Subsites\Middleware\InitStateMiddleware->admin_url_paths) - array values have changed

### `silverstripe/totp-authenticator`

- Changed default value for config [`RegisterHandler.user_help_link`](api:SilverStripe\TOTP\RegisterHandler->user_help_link) from `'https://userhelp.silverstripe.org/en/5/optional_features/multi-factor_authentication/user_manual/using_authenticator_apps/'` to `'https://userhelp.silverstripe.org/en/6/optional_features/multi-factor_authentication/user_manual/using_authenticator_apps/'`
...
- Changed default value for config [`UserForm.has_many`](api:SilverStripe\UserForms\UserForm->has_many) - array values have changed
...
- Removed deprecated class `SilverStripe\Versioned\VersionedGridFieldState\VersionedGridFieldState` - replaced with functionality in [`GridFieldDataColumns`](api:SilverStripe\Forms\GridField\GridFieldDataColumns)
...
- Removed deprecated method `SilverStripe\Versioned\VersionedGridFieldItemRequest::getRecordStatus()` - replaced with [`Versioned::updateStatusFlags()`](api:SilverStripe\Versioned\Versioned::updateStatusFlags())
...
- Changed type of parameter `$registeredMethod` in [`CredentialRepositoryProviderTrait::getCredentialRepository()`](api:SilverStripe\WebAuthn\CredentialRepositoryProviderTrait::getCredentialRepository()) from [`RegisteredMethod`](api:SilverStripe\MFA\Model\RegisteredMethod) to [`RegisteredMethod`](api:SilverStripe\MFA\Model\RegisteredMethod)`|null`
- Changed type of parameter `$registeredMethod` in [`VerifyHandler::getCredentialRequestOptions()`](api:SilverStripe\WebAuthn\VerifyHandler::getCredentialRequestOptions()) from [`RegisteredMethod`](api:SilverStripe\MFA\Model\RegisteredMethod) to [`RegisteredMethod`](api:SilverStripe\MFA\Model\RegisteredMethod)`|null`
...
- Changed default value for config [`DoormanRunner.child_runner`](api:Symbiote\QueuedJobs\Tasks\Engines\DoormanRunner->child_runner) from `'ProcessJobQueueChildTask'` to `'queuedjobs:process-queue-child'`
...
- Removed deprecated method `TractorCow\Fluent\Extension\FluentGridFieldExtension::updateBadge()` - replaced with [`FluentExtension::updateStatusFlags()`](api:TractorCow\Fluent\Extension\FluentExtension::updateStatusFlags())
...
- silverstripe/recipe-kitchen-sink (5.4.0 -&gt; 6.0.0-rc1)
...
- silverstripe/recipe-core (5.4.0 -&gt; 6.0.0-rc1)
...
- silverstripe/assets (2.4.0 -&gt; 3.0.0-rc1)
...
- silverstripe/config (2.2.0 -&gt; 3.0.0-rc1)
...
- silverstripe/framework (5.4.0 -&gt; 6.0.0-rc1)
...
- silverstripe/admin (2.4.0 -&gt; 3.0.0-rc1)
...
- silverstripe/asset-admin (2.4.0 -&gt; 3.0.0-rc1)
...
- silverstripe/versioned-admin (2.4.0 -&gt; 3.0.0-rc1)
...
- silverstripe/cms (5.4.0 -&gt; 6.0.0-rc1)
...
- silverstripe/errorpage (2.4.0 -&gt; 3.0.0-rc1)
...
- silverstripe/reports (5.4.0 -&gt; 6.0.0-rc1)
...
- silverstripe/siteconfig (5.4.0 -&gt; 6.0.0-rc1)
...
- silverstripe/versioned (2.4.0 -&gt; 3.0.0-rc1)
...
- silverstripe/session-manager (2.3.3 -&gt; 3.0.0-rc1)
...
- silverstripe/developer-docs (5.4.0 -&gt; 6.0.0-rc1)
...
- silverstripe/environmentcheck (3.1.0 -&gt; 4.0.0-rc1)
...
- silverstripe/hybridsessions (3.0.5 -&gt; 4.0.0-rc1)
...
- silverstripe/totp-authenticator (5.3.1 -&gt; 6.0.0-rc1)
...
- silverstripe/mfa (5.4.0 -&gt; 6.0.0-rc1)
...
- silverstripe/gridfieldqueuedexport (3.3.0 -&gt; 4.0.0-rc1)
...
- silverstripe/realme (5.5.0 -&gt; 6.0.0-rc1)
...
- silverstripe/sharedraftcontent (3.4.0 -&gt; 4.0.0-rc1)
...
- silverstripe/lumberjack (3.3.0 -&gt; 4.0.0-rc1)
...
- silverstripe/staticpublishqueue (6.3.0 -&gt; 7.0.0-rc1)
...
- silverstripe/taxonomy (3.2.3 -&gt; 4.0.0-rc1)
...
- silverstripe/userforms (6.4.0 -&gt; 7.0.0-rc1)
...
- dnadesign/silverstripe-elemental (5.4.0 -&gt; 6.0.0-rc1)
...
- symbiote/silverstripe-advancedworkflow (6.4.0 -&gt; 7.0.0-rc1)
...
- symbiote/silverstripe-queuedjobs (5.3.0 -&gt; 6.0.0-rc1)
...
- tractorcow/silverstripe-fluent (7.3.0 -&gt; 8.0.0-rc1)
...
- silverstripe/linkfield (4.2.0 -&gt; 5.0.0-rc1)
...
- silverstripe/graphql (5.3.0 -&gt; 6.0.0-rc1)
...
- silverstripe/subsites (3.4.0 -&gt; 4.0.0-rc1)
...
- silverstripe/blog (4.4.0 -&gt; 5.0.0-rc1)
...
- silverstripe/crontask (3.1.0 -&gt; 4.0.0-rc1)
...
- silverstripe/campaign-admin (2.4.0 -&gt; 3.0.0-rc1)
...
- silverstripe/mimevalidator (3.1.0 -&gt; 4.0.0-rc1)
...
- silverstripe/tagfield (3.4.0 -&gt; 4.0.0-rc1)
...
- dnadesign/silverstripe-elemental-userforms (4.2.0 -&gt; 5.0.0-rc1)
  - 2025-04-22 [f2f5314](https://github.com/dnadesign/silverstripe-elemental-userforms/commit/f2f5314975eb07aab33bb75872c53e2dedef1ea9) Remove duplicated use statements (Steve Boyd)
  - 2025-04-15 [2d8d724](https://github.com/dnadesign/silverstripe-elemental-userforms/commit/2d8d724e5a2357568518422b81b564c1093d5ccd) Remove duplicated use statements (#113) (Guy Sartorelli)
...
- symbiote/silverstripe-gridfieldextensions (4.1.0 -&gt; 5.0.0-rc1)
...
- colymba/gridfield-bulk-editing-tools (4.1.3 -&gt; 5.0.0-rc1)
...
- silverstripe/dynamodb (5.0.1 -&gt; 6.0.0-rc1)
...
- silverstripe/installer (5.4.0 -&gt; 6.0.0-rc1)
...
- silverstripe/vendor-plugin (2.1.0 -&gt; 3.0.0-rc1)
...
- silverstripe/login-forms (5.3.0 -&gt; 6.0.0-rc1)
...
- silverstripe/webauthn-authenticator (5.3.1 -&gt; 6.0.0-rc1)
...
- silverstripe/spamprotection (4.2.2 -&gt; 5.0.0-rc1)
...
- silverstripe/textextraction (4.1.1 -&gt; 5.0.0-rc1)
...
- silverstripe/recipe-cms (5.4.0 -&gt; 6.0.0-rc1)
...
- silverstripe/segment-field (3.3.0 -&gt; 4.0.0-rc1)
...
- dnadesign/silverstripe-elemental-userforms (4.2.0 -&gt; 5.0.0-rc1)
  - 2025-04-14 [8760079](https://github.com/dnadesign/silverstripe-elemental-userforms/commit/87600794cf816d168ea9093f15cfe0caaf3ba21e) Update PHPDoc to pass linting (#112) (Guy Sartorelli)
