...
The site tree now also includes some additional ARIA attributes to improve accessibility for users relying on assistive technologies like screen readers.
