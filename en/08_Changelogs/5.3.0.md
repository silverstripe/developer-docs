...
- `silverstripe/linkfield` now has improved accesibilty support for screen readers and keyboard navigation. Also, focus states have been made consistent when using a keyboard or a mouse.
