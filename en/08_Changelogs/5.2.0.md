...
- The [Composer runtime api](https://getcomposer.org/doc/07-runtime.md#installed-versions) is now being used in the VersionProvider class instead of relying on the composer.lock file.
